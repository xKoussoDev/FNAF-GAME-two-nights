...
namespace UnityEditor.U2D
{
    static internal class MenuItems
    {
        ...
        internal class DoCreateSpriteAtlas : ProjectWindowCallback.AssetCreationEndAction
        {
            public int sides;
        ...
        static private void CreateSpriteAtlas()
        {
            ...
            ProjectWindowUtil.StartNameEditingIfProjectWindowExists(EntityId.None, action, "New Sprite Atlas.spriteatlasv2", icon, null);
        }
